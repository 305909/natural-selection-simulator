...
def simulation(homo,
               ...
               lifetime,
               districts):
    # initializing the simulation time [years]
    time = 0
    # the colony register
    ...
    extinction = dict()
    # randomly choosing the origin sites for each clan
    ...
    for clan, colony in zip(homo.keys(), origins):
        ...
        # initializing the dict data type to archive the clan individuals
        ...
        # inserting the clan into the clan register
        nature[clan] = Clan(clan,
                            ...
                            population,
                            0)
        # inserting the colony into the colony register
        world[colony].colonization(clan, species)
        # inserting the species into the species register
    ...
    for clan in nature.keys():
        ...
        for individual in nature[clan].individuals.values():
            # inserting the death of the individual into the FES
    ...
    while bool(FES.queue):
        # getting the future event from the FES
